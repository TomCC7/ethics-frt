<div id="side-navbar" class="sidebar">
  ...
  <ul id="side-navbar-menu" class="menu">
    ...
    @auth
      <a class="side-navbar-link" href="/"><li class="side-navbar-item"> Dashboard </li></a>
      <a class="side-navbar-link" href="{{route('contents.index')}}"><li class="side-navbar-item">Contents </li></a>
    @endauth

    @can('admin')
      <a class="side-navbar-link" href="{{route('users.index')}}"><li class="side-navbar-item">Users</li></a>
      <a class="side-navbar-link" href="{{route('answers.index')}}"><li class="side-navbar-item">Answers</li></a>
    @endcan
    ...
    @auth
      ...
      <a class="side-navbar-link dropdown" role="button" data-toggle="dropdown" href="#">
        <li class="side-navbar-item dropdown-toggle">Hello,
          <strong>{{ Auth::user()->name }}</strong></li></a>
